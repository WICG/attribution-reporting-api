...
The `source-type` will be included as a new key in the [report JSON](https://github.com/WICG/conversion-measurement-api/blob/main/event_attribution_reporting_clicks.md#attribution-reports). It will have a value of either "event" or "navigation".
